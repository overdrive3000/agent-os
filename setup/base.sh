...
BASE_URL="https://raw.githubusercontent.com/overdrive3000/agent-os/main"
...
echo "   $INSTALL_DIR/agents/            - Layered AGENTS templates"
echo "   $INSTALL_DIR/cursor/commands/   - Cursor command pack"
echo "   $INSTALL_DIR/codex/prompts/     - Codex prompt pack"
echo "   $INSTALL_DIR/commands/          - Legacy command templates"
...
echo ""
echo "2. Tune layered AGENTS templates in $INSTALL_DIR/agents/"
echo ""
echo "3. Configure project types in $INSTALL_DIR/config.yml"
echo ""
echo "4. Navigate to a project directory and run: $PROJECT_SCRIPT"
echo ""
echo "--------------------------------"
echo ""
